...
execute unless score @s gcd matches 0.. unless score @s chant matches 0.. if score slot bac matches -106 at @s run function ff14:std/class/check_chant
execute unless score @s chant matches 0.. if score slot bac matches -106 run function ff14:std/class/check_ab
