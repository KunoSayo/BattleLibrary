...
summon minecraft:armor_stand 0 65 0 {CustomName:'{"text":"0级 巴尔巴莉希娅", "color":"red"}', CustomNameVisible:1b, Invisible: 1b, NoBasePlate:1b, Invulnerable:1b, DisabledSlots:1b, ArmorItems:[{id:"minecraft:leather_boots",Count:1b,tag:{display:{color: 65280}}},{id:"minecraft:leather_leggings",Count:1b,tag:{display:{color: 65280}}},{id:"minecraft:leather_chestplate",Count:1b,tag:{display:{color: 65280}}},{id:"minecraft:leather_helmet",Count:1b, tag:{display:{color: 65280}}}], Tags:[boss, ffc, ffcboss]}
